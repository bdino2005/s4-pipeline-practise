    ...
    stage('update helm charts-dev') {
         when{ 
	      ...
	      steps {
	        script {
	          withCredentials([
	            string(credentialsId: 'blaise_image', variable: 'IMAGE')
	          ]) {
...
EOF
                ...
                git push https://bdino2005:$IMAGE@github.com/bdino2005/s4-pipeline-practise.git
	            '''
	          }
...
EOF
                git add -A 
                git commit -m "testing jenkins"
                git push https://bdino2005:$IMAGE@github.com/bdino2005/s4-pipeline-practise.git  || true
